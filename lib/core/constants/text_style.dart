...
abstract final class ToyVillageTextStyle {
  ...
  /// Calendar
  static TextStyle calendar1 = defaultTextStyle.copyWith(
    fontSize: 14,
    fontWeight: FontWeight.w400,
  );

  static TextStyle calendar2 = defaultTextStyle.copyWith(
    fontSize: 16,
    fontWeight: FontWeight.w500,
  );
  
  static TextStyle calendar3 = defaultTextStyle.copyWith(
    fontSize: 14,
    fontWeight: FontWeight.w500,
  );
}
